            ...
            <div className="flex justify-between items-center mb-5">
              ...
              <div className="relative flex items-center group">
                <input
                  ...
                  className="md:w-52 w-48  h-8 pl-2.5 pr-8 text-xs rounded-md border border-Gray shadow-[0_1px_6px_0_rgba(217,217,217,1)] focus:outline focus:border-sky-500 focus:outline-sky-500 placeholder:text-xs"
                />
                <Icon
                ...
                return (
                  <li key={key} className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-4 ">
                      ...
                      <button className="md:w-24 w-16 py-2 bg-sky-700 rounded-full text-sm font-medium text-white text-center">
                        Beli
                      </button>
                    </div>
                  </li>
